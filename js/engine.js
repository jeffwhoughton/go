...
/* ===================== search ====================== */
const LEVELS = [
  { name: 'Absolute beginner', rank: '~25 kyu', visits: 1,   temp: 4.0,  rand: 0.45 },
  { name: 'Beginner',          rank: '~18 kyu', visits: 1,   temp: 3.0,  rand: 0.25 },
  { name: 'Novice',            rank: '~14 kyu', visits: 1,   temp: 2.2,  rand: 0.12 },
  { name: 'Casual',            rank: '~10 kyu', visits: 1,   temp: 1.6,  rand: 0.05 },
  { name: 'Improving',         rank: '~7 kyu',  visits: 1,   temp: 1.2,  rand: 0.00 },
  { name: 'Club player',       rank: '~4 kyu',  visits: 3,   temp: 0.9,  rand: 0.00 },
  { name: 'Strong club',       rank: '~1 kyu',  visits: 10,  temp: 0.6,  rand: 0.00 },
  { name: 'Shodan',            rank: '~1 dan',  visits: 25,  temp: 0.35, rand: 0.00 },
  { name: 'Two dan',           rank: '~2 dan',  visits: 60,  temp: 0.20, rand: 0.00 },
  { name: 'Three dan',         rank: '~3 dan',  visits: 150, temp: 0.10, rand: 0.00 },
  { name: 'Four dan',          rank: '~4 dan',  visits: 320, temp: 0.00, rand: 0.00 },
  { name: 'Maximum',           rank: 'full strength', visits: 800, temp: 0.0, rand: 0.0 },
];
